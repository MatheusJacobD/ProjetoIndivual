...
('Gambito do Rei', 'Abertura romântica e explosiva, com iniciativa cedo e muita tática.', 1),
('Defesa Siciliana Najdorf', 'Abertura dinâmica e extremamente rica em contrajogo e ataques.', 1),
('Defesa Índia do Rei', 'Defesa agressiva e assimétrica, ideal para complicar a posição.', 1),
('Defesa Siciliana', 'Abertura combativa e tática, com forte potencial ofensivo.', 1),
('Defesa Grünfeld', 'Defesa dinâmica, moderna e com muito jogo ativo.', 1),

('Abertura Ruy López', 'Abertura clássica, profunda e muito forte em planos estratégicos.', 2),
('Gambito da Rainha', 'Abertura sólida e posicional, com grande controle central.', 2),
('Defesa Nimzo-Índia', 'Abertura posicional e flexível, com pressão estratégica constante.', 2),
('Abertura Inglesa', 'Abertura flexível, rica em manobras e planos de longo prazo.', 2),
('Defesa Índia da Dama', 'Defesa elegante e estratégica, com grande controle posicional.', 2),

('Defesa Caro-Kann', 'Defesa estável e precisa, focada em estrutura e segurança.', 3),
('Defesa Berlim', 'Defesa técnica e fria, famosa por neutralizar a iniciativa.', 3),
('Defesa Eslava', 'Defesa robusta, equilibrada e muito respeitada na teoria.', 3),
('Defesa Petroff', 'Defesa objetiva e confiável, com foco em solidez.', 3),
('Defesa Francesa', 'Estrutura fechada e estratégia paciente, com jogo de longo prazo.', 3);
